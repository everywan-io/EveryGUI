...
import {OperatorRoles} from '@models/operators.model';
...
@Component({
    selector: 'app-operators-filters',
...
export class FiltersComponent implements OnInit {
    ...
    constructor(private pickerConfig: DatepickerConfig,
        ...
        this.filterOptionsDescriptors = {
            roles: [
                { title: this.translator.instant('commons.roles.admin'), value: OperatorRoles.ADMIN },
                { title: this.translator.instant('commons.roles.operator'), value: OperatorRoles.OPERATOR }
            ]
        };
