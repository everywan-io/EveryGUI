...
import {OverlayNetType} from '@models/overlaynets.model';
...
@Component({
    selector: 'app-overlaynets-filters',
...
export class FiltersComponent implements OnInit {
    ...
    constructor(private pickerConfig: DatepickerConfig,
        ...
        this.filterOptionsDescriptors = {
            roles: [
                // { title: this.translator.instant('overlaynets.types.router'), value: OverlayNetType.ROUTER },
                // { title: this.translator.instant('commons.roles.overlaynet'), value: OverlayNetType.OPERATOR }
            ]
        };
